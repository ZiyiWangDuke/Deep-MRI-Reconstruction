...
def compile_fn(network, net_config, base_lr,l2):
    """
...
if __name__ == '__main__':
    ...
    # Compile function
    train_fn, val_fn = compile_fn(net, net_config, base_lr,l2)
    ...
    for epoch in range(num_epoch):
        ...
        for im in iterate_minibatch(train, batch_size, shuffle=True):
            # generate acc randomly from 1 to 6
            print(k)
            k+=1
            acc = np.random.random(1)*5+1
