...
from .kspace_weight_layer import kspace_weight_layer
...
conv1 = Conv2D(filters = 32, kernel_size = 3, strides=2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(input_fft)
...
# dc1 = kspace_weight_layer(im_w=img_w, flag='do_weigh')(dc1)
...
res2 = Add()([dc1,conv2])
# add data consistency layer here
# res2 = kspace_weight_layer(im_w=img_w, flag='undo_weigh')(res2)
...
# dc3 = kspace_weight_layer(im_w=img_w, flag='do_weigh')(dc3)
dc3 = fft_layer(fft_dir = False)(dc3)

# 5 conv sequential, in k-space
...
# res4 = kspace_weight_layer(im_w=img_w, flag='undo_weigh')(res4)
